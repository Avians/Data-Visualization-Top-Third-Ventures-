...
/**
 * -----------------------------------------------------------------------------
 * THIS IS THE ZILAS PHP FRAMEWORK CLASS FOR ENSURING PROPER FILE UPLOAD.
 * 
 * IT ALLOWS FOR FILE UPLOAD WHILE CHECKING VARIOUS FILE SECURITIES.  
 * -----------------------------------------------------------------------------
 *
 * @author incorporated by Mathew Juma O. (ATHIAS AVIANS) <mathew@headsafrica.com>
