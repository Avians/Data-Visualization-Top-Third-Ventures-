    ...
    <div class="container">
        ...
        <div class="row-fluid quote-v1">
            <div class="span7 quote-v1-inner">
                <span>SACDA - Members board</span>
            </div>
            <div class="span2 offset1 quote-v1-inner text-right">
                <a class="btn-transparent" href="http://www.keenthemes.com/preview/index.php?theme=metronic_admin" target="_blank"><i class="icon-rocket margin-right-10"></i>Member Login</a>
            ...
            <div class="span2 quote-v1-inner text-right">
                <a class="btn-transparent" href="http://www.keenthemes.com/preview/index.php?theme=metronic_admin" target="_blank"><i class="icon-rocket margin-right-10"></i>Admin Login</a>
                <!--<a class="btn-transparent" href="http://themeforest.net/item/metronic-responsive-admin-dashboard-template/4021469"><i class="icon-gift margin-right-10"></i>Purchase 2 in 1</a>-->
            </div>
        </div>
                ...
                <ul class="bxslider">
                    <li>
                        <em>
                            ...
                            <a href="images/works/img1.jpg" class="fancybox-button" title="Project Name #1" data-rel="fancybox-button"><i class="icon-search icon-hover icon-hover-2"></i></a>
                        </em>
                    ...
                    <li>
                        <em>
                            ...
                            <a href="portfolio_item.html"><i class="icon-link icon-hover icon-hover-1"></i></a>
                            <a href="images/works/img2.jpg" class="fancybox-button" title="Project Name #2" data-rel="fancybox-button"><i class="icon-search icon-hover icon-hover-2"></i></a>
                        </em>
                        <a class="bxslider-block" href="#">
                            <strong>Amazing Project</strong>
                            <b>Agenda corp.</b>
                    ...
                    <li>
                        <em>
                            ...
                            <a href="portfolio_item.html"><i class="icon-link icon-hover icon-hover-1"></i></a>
                            <a href="images/works/img3.jpg" class="fancybox-button" title="Project Name #3" data-rel="fancybox-button"><i class="icon-search icon-hover icon-hover-2"></i></a>
                        </em>
                        <a class="bxslider-block" href="#">
                            <strong>Amazing Project</strong>
                            <b>Agenda corp.</b>
                    ...
                    <li>
                        <em>
                            ...
                            <a href="portfolio_item.html"><i class="icon-link icon-hover icon-hover-1"></i></a>
                            <a href="images/works/img4.jpg" class="fancybox-button" title="Project Name #4" data-rel="fancybox-button"><i class="icon-search icon-hover icon-hover-2"></i></a>
                        </em>
                        <a class="bxslider-block" href="#">
                            <strong>Amazing Project</strong>
                            <b>Agenda corp.</b>
                    ...
                    <li>
                        <em>
                            ...
                            <a href="portfolio_item.html"><i class="icon-link icon-hover icon-hover-1"></i></a>
                            <a href="images/works/img5.jpg" class="fancybox-button" title="Project Name #5" data-rel="fancybox-button"><i class="icon-search icon-hover icon-hover-2"></i></a>
                        </em>
                        <a class="bxslider-block" href="#">
                            <strong>Amazing Project</strong>
                            <b>Agenda corp.</b>
                    ...
                    <li>
                        <em>
                            ...
                            <a href="portfolio_item.html"><i class="icon-link icon-hover icon-hover-1"></i></a>
                            <a href="images/works/img6.jpg" class="fancybox-button" title="Project Name #6" data-rel="fancybox-button"><i class="icon-search icon-hover icon-hover-2"></i></a>
                        </em>
                        <a class="bxslider-block" href="#">
                            <strong>Amazing Project</strong>
                            <b>Agenda corp.</b>
        ...
        <div class="row-fluid mix-block">
            ...
            <div class="span7 tab-style-1 margin-bottom-20">
                ...
                <div class="tab-content">
                    <div class="tab-pane row-fluid fade in active" id="tab-1">
                        <div class="span3">
                            <a href="images/photos/img7.jpg" class="fancybox-button" title="Image Title" data-rel="fancybox-button">
                                <img class="img-circle" src="images/photos/img7.jpg" alt="" />
                            </a>
                        </div>
                        <div class="span9">
                    ...
                    <div class="tab-pane fade" id="tab-2">
                        ...
                        <div class="span3">
                            <a href="images/photos/img10.jpg" class="fancybox-button" title="Image Title" data-rel="fancybox-button">
                                <img class="img-circle" src="images/photos/img10.jpg" alt="" />
                            </a>
                        </div>
                    </div>
            ...
            <div class="span5 testimonials-v1">
                <h2 style="font-family: Oswald-Light; letter-spacing: 2px; color: #35aa47;">Announcements</h2>
                    ...
                    <div class="carousel-inner">
                        <div class="active item">
                            ...
                            <div class="carousel-info">
                                <img class="pull-left" src="images/people/img1-small.jpg" alt="" />
                                <div class="pull-left">
                        ...
                        <div class="item">
                            ...
                            <div class="carousel-info">
                                <img class="pull-left" src="images/people/img5-small.jpg" alt="" />
                                <div class="pull-left">
                        ...
                        <div class="item">
                            ...
                            <div class="carousel-info">
                                <img class="pull-left" src="images/people/img2-small.jpg" alt="" />
                                <div class="pull-left">
        ...
        <div class="row-fluid margin-bottom-40">
            ...
            <div class="span9">
                <ul class="bxslider1 clients-list">
                    <li>
                        <img src="images/clients/client_1_gray.png" alt="" /> 
                        <img src="images/clients/client_1.png" class="color-img" alt="" />
                    </li>
                    <li>
                        <img src="images/clients/client_2_gray.png" alt="" /> 
                        <img src="images/clients/client_2.png" class="color-img" alt="" />
                    </li>
                    <li>
                        <img src="images/clients/client_3_gray.png" alt="" /> 
                        <img src="images/clients/client_3.png" class="color-img" alt="" />
                    </li>
                    <li>
                        <img src="images/clients/client_4_gray.png" alt="" /> 
                        <img src="images/clients/client_4.png" class="color-img" alt="" />
                    </li>
                    <li>
                        <img src="images/clients/client_5_gray.png" alt="" /> 
                        <img src="images/clients/client_5.png" class="color-img" alt="" />
                    </li>
                    <li>
                        <img src="images/clients/client_6_gray.png" alt="" /> 
                        <img src="images/clients/client_6.png" class="color-img" alt="" />
                    </li>
                    <li>
                        <img src="images/clients/client_7_gray.png" alt="" /> 
                        <img src="images/clients/client_7.png" class="color-img" alt="" />
                    </li>
                    <li>
                        <img src="images/clients/client_8_gray.png" alt="" /> 
                        <img src="images/clients/client_8.png" class="color-img" alt="" />
                    </li>
                </ul>                        
            </div>
        </div>
