<?php
    ...
    $zf_controller->Zf_loadModel("platform_data", "OccupationAnalysis");
...
?>
            ...
            <div id="dashboard">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-time"></i>Gender Filter - <?php echo $portletTitle."s by:"; ?></div>
                                <div class="actions">
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
                                            ...
                                            <input type="hidden" id="occupation" name="occupation" value="<?php echo $portletTitle; ?>" />
                ...
                <div class="row-fluid">
                    <div class="span6">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-time"></i><?php echo $portletTitle; ?>s - Gender Ratio</div>
                                <div class="tools">
                                    <a href="" class="collapse"></a>
                                </div>
                            </div>
                    ...
                    <div class="span6">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-certificate"></i><?php echo $portletTitle; ?>s - Age Distribution</div>
                                <div class="tools">
                                    <a href="" class="collapse"></a>
                                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                    <a href="" class="reload"></a>
                ...
                <div class="row-fluid">
                    <div class="span4">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-briefcase"></i><?php echo $portletTitle; ?>s - Education</div>
                                <div class="tools">
                                    <a href="" class="collapse"></a>
                                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                    <a href="" class="reload"></a>
                    ...
                    <div class="span4">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-book"></i><?php echo $portletTitle; ?>s - Marital</div>
                                <div class="tools">
                                    <a href="" class="collapse"></a>
                                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                    <a href="" class="reload"></a>
                    ...
                    <div class="span4">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-money"></i><?php echo $portletTitle; ?>s - Income</div>
                                <div class="tools">
                                    <a href="" class="collapse"></a>
                                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                    <a href="" class="reload"></a>
    ...
    $(document).ready(function() {
        ...
        var $current_view = "occupationAnalysis";
