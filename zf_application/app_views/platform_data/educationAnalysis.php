<?php
    ...
    $zf_controller->Zf_loadModel("platform_data", "EducationAnalysis");
...
?>
            ...
            <div id="dashboard">
                ...
                <div class="row-fluid">
                    <div class="span9">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-globe"></i><?php echo $portletTitle; ?> Level, Project Countries</div>
                                <div class="tools">
                    ...
                    <div class="span3">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-bar-chart"></i><?php echo $portletTitle; ?> Level, Statistics</div>
                                <div class="tools">
                                    <a href="" class="collapse"></a>
                                </div>
                            </div>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-time"></i>Gender Filter - <?php echo $portletTitle." Level by:"; ?></div>
                                <div class="actions">
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
                                            ...
                                            <input type="hidden" id="educationLevel" name="educationLevel" value="<?php echo $portletTitle; ?>" />
                ...
                <div class="row-fluid">
                    <div class="span6">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-time"></i><?php echo $portletTitle; ?> Level, Gender Ratio</div>
                                <div class="tools">
                                    <a href="" class="collapse"></a>
                                </div>
                            </div>
                    ...
                    <div class="span6">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-certificate"></i><?php echo $portletTitle; ?> Level, Age Distribution</div>
                                <div class="tools">
                                    <a href="" class="collapse"></a>
                                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                    <a href="" class="reload"></a>
                ...
                <div class="row-fluid">
                    <div class="span4">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-book"></i><?php echo $portletTitle; ?>, Marital</div>
                                <div class="tools">
                                    <a href="" class="collapse"></a>
                                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                    <a href="" class="reload"></a>
                    ...
                    <div class="span4">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-money"></i><?php echo $portletTitle; ?>, Income</div>
                                <div class="tools">
                                    <a href="" class="collapse"></a>
                                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                    <a href="" class="reload"></a>
    ...
    $(document).ready(function() {
        ...
        var $current_view = "educationAnalysis";
