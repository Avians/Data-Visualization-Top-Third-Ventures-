<?php
    ...
    $zf_controller->Zf_loadModel("platform_data", "MaritalAnalysis");
...
?>
            ...
            <div id="dashboard">
                            ...
                            <div class="portlet-body">
                                <div class="scroller" style="height:300px" data-always-visible="1" data-rail-visible="0">           
                                   <?php
                                        ...
                                        $houseHolds        = $zf_controller->zf_targetModel->HouseHolds("maritalStatus_".$zf_actionData);
                                        $allChildren       = $zf_controller->zf_targetModel->AllChildren("maritalStatus_".$zf_actionData);
                                        $childrenUnderFive = $zf_controller->zf_targetModel->ChildrenUnderFive("maritalStatus_".$zf_actionData);
                                        $allBenefactors    = $zf_controller->zf_targetModel->AllBenefactors("maritalStatus_".$zf_actionData);
                                    ?>
                ...
                <div class="row-fluid">
                    <div class="span6">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-certificate"></i><?php echo $portletTitle; ?> - Gender Distribution</div>
                                <div class="tools">
                                    <a href="" class="collapse"></a>
                                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                    <a href="" class="reload"></a>
                ...
                <div class="row-fluid">
                    <div class="span4">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-book"></i><?php echo $portletTitle; ?> - Eduction Level</div>
                                <div class="tools">
                                    <a href="" class="collapse"></a>
                                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                    <a href="" class="reload"></a>
    ...
    $(document).ready(function() {
        ...
        var $current_view = "maritalAnalysis";
