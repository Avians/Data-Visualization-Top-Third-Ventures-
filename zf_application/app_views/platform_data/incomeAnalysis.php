<?php
    ...
    $zf_controller->Zf_loadModel("platform_data", "IncomeAnalysis");
...
?>
            ...
            <div id="dashboard">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span3">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-bar-chart"></i> General Statistics</div>
                                <div class="tools">
                                    <a href="" class="collapse"></a>
                                </div>
                            </div>
                            <div class="portlet-body">
                                <div class="scroller" style="height:300px" data-always-visible="1" data-rail-visible="0">           
                                   <?php
                                        ...
                                        $houseHolds        = $zf_controller->zf_targetModel->HouseHolds("monthlyIncome_".$zf_actionData);
                                        $allChildren       = $zf_controller->zf_targetModel->AllChildren("monthlyIncome_".$zf_actionData);
                                        $childrenUnderFive = $zf_controller->zf_targetModel->ChildrenUnderFive("monthlyIncome_".$zf_actionData);
                                        $allBenefactors    = $zf_controller->zf_targetModel->AllBenefactors("monthlyIncome_".$zf_actionData);
                                    ?>
                ...
                <div class="row-fluid">
                    <div class="span6">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-certificate"></i> Gender Ratio</div>
                                <div class="tools">
                                    <a href="" class="collapse"></a>
                                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                    <a href="" class="reload"></a>
                ...
                <div class="row-fluid">
                    <div class="span4">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-book"></i> Marital Status</div>
                                <div class="tools">
                                    <a href="" class="collapse"></a>
                                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                    <a href="" class="reload"></a>
                            ...
                            <div class="portlet-body">
                                ...
                                <div id="maritalChart" style="height:240px" data-always-visible="0" data-rail-visible="0"></div>
                    ...
                    <div class="span4">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-briefcase"></i> EducationLevel</div>
                                <div class="tools">
                                    <a href="" class="collapse"></a>
                                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                    <a href="" class="reload"></a>
                    ...
                    <div class="span4">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-money"></i> Occupation</div>
                                <div class="tools">
                                    <a href="" class="collapse"></a>
                                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                    <a href="" class="reload"></a>
                            ...
                            <div class="portlet-body">
                                ...
                                <div id="occupationChart" style="height:240px" data-always-visible="0" data-rail-visible="0">Athias</div>
    ...
    $(document).ready(function() {
        ...
        var $current_view = "incomeAnalysis";
